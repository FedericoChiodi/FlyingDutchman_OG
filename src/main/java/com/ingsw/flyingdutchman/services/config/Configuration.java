...
public class Configuration {
    ...
    public static final String DATABASE_URL = "jdbc:mysql://localhost:3306/flyingdutchmandb?user=java&password=StrongPassword123@&allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=" + SERVER_TIMEZONE;
